                                            ...
                                            <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 xl:grid-cols-5">
                                                {slots.map((slot) => (
                                                    <button
                                                        ...
                                                        className={`rounded-2xl border px-4 py-3 text-sm font-semibold transition ${!slot.available
                                        ...
                                        <div className="space-y-4">
                                            {flow.store.products.map((product) => {
                                                ...
                                                return (
                                                    <div
                                                        key={product.id}
                                                        className={`rounded-3xl border p-5 transition ${selected ? "border-slate-950 bg-slate-50" : "border-slate-200 bg-white"
                                                            }`}
                                                    >
                                                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                                            <div>
                                                                ...
                                                                <p className="mt-2 text-sm text-slate-500">
                                                                    {formatCurrency(product.price)} · Durasi {product.bookingDurationMin ?? flow.store?.bookingSlotMinutes ?? 0} menit
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`rounded-2xl px-4 py-2.5 text-sm font-semibold transition ${selected
