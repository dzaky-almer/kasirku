...
import type { PublicStoreBookingData } from "@/lib/booking/types";
...
type BookingFlowContextValue = BookingFlowState & {
  resource: PublicStoreBookingData["bookingResources"][number] | null;
  selectedProducts: Array<PublicStoreBookingData["products"][number] & { qty: number }>;
  totalAmount: number;
